...
public class ShardedQueryImpl implements ShardedQuery {
   ...
   * @param shards list of org.hibernate.shards on which this query will be executed
   ...
   * implementation would require re-querying org.hibernate.shards frequently and a
   ...
   * query on all org.hibernate.shards
   * @throws HibernateException
   */
