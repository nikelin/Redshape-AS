...
public class ShardedSessionFactoryImpl implements ShardedSessionFactoryImplementor, ControlSessionProvider {
  ...
  // map of all existing SessionFactories, used when creating a new ShardedSessionFactory for some subset of org.hibernate.shards
   ...
   * @param shardIds The ids of the org.hibernate.shards with which this SessionFactory
   * should be associated.
   * @param sessionFactoryShardIdMap Mapping of SessionFactories to shard ids.
   * When using virtual org.hibernate.shards, this map associates SessionFactories (physical
   * org.hibernate.shards) with virtual org.hibernate.shards (shard ids).  Map cannot be empty.
  ...
  public ShardedSessionFactoryImpl(
    ...
    // that isn't in the full list of org.hibernate.shards
  ...
  /**
   * Warning: this interceptor will be shared across all org.hibernate.shards, so be very
   ...
   * ShardedSessionFactory reuses existing org.hibernate.shards. Most common use will be to
