...
class ShardedSubcriteriaImpl implements ShardedSubcriteria {
  ...
  // all org.hibernate.shards that we're aware of
  ...
  // maps org.hibernate.shards to actual Criteria objects
  private final Map<Shard, Criteria> shardToCriteriaMap = Maps.newHashMap();

  // maps org.hibernate.shards to lists of criteria events that need to be applied
   ...
   *
   * @param shards the org.hibernate.shards that we're aware of
   ...
   * across _all_ org.hibernate.shards, not each shard.
   */
