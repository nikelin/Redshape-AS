...
public class PropertyUtils {
    final private static PropertyUtils instance = new PropertyUtils();
    ...
    public Map<String, Property> getPropertiesMap( Class<?> type ) throws IntrospectionException {
        return this.getPropertiesMap( type, BeanAccess.FIELD );
    }

    public Map<String, Property> getPropertiesMap(Class<?> type,
        ...
        if (properties.isEmpty()) {
            throw new IntrospectionException("No JavaBean properties found in "
                    + type.getName());
        }
    ...
    public Property getProperty(Class<? extends Object> type, String name,
        ...
        if (property == null || !property.isWritable()) {
            throw new IntrospectionException("Unable to find property '" + name
