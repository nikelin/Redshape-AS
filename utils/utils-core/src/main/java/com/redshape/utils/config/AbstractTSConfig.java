 ...
 */
public abstract class AbstractTSConfig implements IConfig {
    ...
    protected AbstractTSConfig() {
        this(null, null, null);
    }

    protected AbstractTSConfig(IConfig parent, String name, String value) {
        this.parent = parent;
        this.name = name;
        this.value = value;
    }

    protected AbstractTSConfig(String name, String value) {
        this(null, name, value);
    }

    public AbstractTSConfig(IConfigSource source) throws ConfigException {
        this.source = source;
        this.init();
    }
