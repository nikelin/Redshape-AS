...
public class PackagesLoader {
    ...
    public <T> Class<T>[] getClasses( String path, String pkgName, IFilter<Class<?>> filter ) throws PackageLoaderException {
    ...
    protected <T> Class<T>[] getClassesFromJar( String path, String pkgName, IFilter<Class<?>> filter ) throws PackageLoaderException {
        try {
