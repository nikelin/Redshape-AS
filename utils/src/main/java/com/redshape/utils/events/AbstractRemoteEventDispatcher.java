 ...
 */
public abstract class AbstractRemoteEventDispatcher implements IRemoteEventDispatcher {
	private static final long serialVersionUID = -5634548425272215457L;
	
	private Map<Class<? extends IEvent>, Collection<IEventListener<IEvent>>> listeners 
    					= new HashMap<Class<? extends IEvent>, 
								Collection<IEventListener<IEvent>>>();
    ...
    public <T extends IEvent> void removeEventListener( Class<T> type, 
    		IEventListener<? extends T> listener ) throws RemoteException {
