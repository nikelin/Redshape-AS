 ...
 */
public class ModuloFunction extends Function<Object, Double> {

	private IEvaluator evaluator;

	public ModuloFunction( IEvaluator evaluatorContext ) {
	...
	public Double invoke(Object... arguments) throws InvocationTargetException {
		...
		return (Double) arguments[0] % (Integer) arguments[1];
	}
