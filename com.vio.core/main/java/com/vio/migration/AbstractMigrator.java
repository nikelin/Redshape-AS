...
import com.vio.migration.renderers.mysql.CreateTableRenderer;
import com.vio.migration.renderers.mysql.DropTableRenderer;
...
public abstract class AbstractMigrator implements Migrator {
    ...
    private Connection createConnection() throws ProviderException, SQLException {
        try {
